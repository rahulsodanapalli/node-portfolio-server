...
/**
 * Seeds static baseline portfolio items if respective database collections are empty.
 * This separation ensures clean codebase architecture and simple testing boundaries.
 */
